...
@NgModule({
  ...
  imports: [
    ...
    { path: 'employees/register',data:{name: 'EmployeesRegister'}, component: EmployeeRegisterComponent },
    { path: 'employees/:id',data:{name: 'EmployeesId'}, component: EmployeeComponent },
